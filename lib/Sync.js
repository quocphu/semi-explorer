...
Sync.prototype.storeTipBlock = function(b, allowReorgs, cb) {
  ...
  async.series([
      ...
      function(c) {
        ...
        // Check previous block hash is existed in db.
        // If does not exist and isn't genesis block hash --> throw err
      ...
      function(c) {
        ...
        // Get last block
        // Check last block hash and new block previous hash is same
